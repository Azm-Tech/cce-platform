    ...
    IClassFixture<AdminAuthFixture>
{
    ...
    public AuditEventsEndpointTests(
    ...
    public async Task Anonymous_request_returns_401()
    {
        ...
        var resp = await client.GetAsync(new Uri("/api/admin/audit-events", UriKind.Relative));
    ...
    public async Task SuperAdmin_request_returns_200_with_paged_result_shape()
    {
        ...
        var resp = await client.GetAsync(new Uri("/api/admin/audit-events?page=1&pageSize=20", UriKind.Relative));
