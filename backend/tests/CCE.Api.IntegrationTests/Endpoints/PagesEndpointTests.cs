...
public class PagesEndpointTests :
    ...
    IClassFixture<AdminAuthFixture>
{
    ...
    public async Task List_anonymous_returns_401()
    {
        ...
        var resp = await client.GetAsync(new Uri("/api/admin/pages", UriKind.Relative));
    ...
    public async Task List_SuperAdmin_returns_200_with_paged_result_shape()
    {
        ...
        var resp = await client.GetAsync(new Uri("/api/admin/pages?page=1&pageSize=20", UriKind.Relative));
    ...
    public async Task GetById_anonymous_returns_401()
    {
        ...
        var resp = await client.GetAsync(new Uri($"/api/admin/pages/{System.Guid.NewGuid()}", UriKind.Relative));
    ...
    public async Task Post_anonymous_returns_401()
    {
        ...
        var resp = await client.PostAsync(new Uri("/api/admin/pages", UriKind.Relative), body);
