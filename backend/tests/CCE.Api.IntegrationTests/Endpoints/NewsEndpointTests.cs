    ...
    IClassFixture<AdminAuthFixture>
{
    ...
    public async Task List_anonymous_returns_401()
    {
        ...
        var resp = await client.GetAsync(new Uri("/api/admin/news", UriKind.Relative));
    ...
    public async Task List_SuperAdmin_returns_200_with_paged_result_shape()
    {
        ...
        var resp = await client.GetAsync(new Uri("/api/admin/news?page=1&pageSize=20", UriKind.Relative));
    ...
    public async Task Delete_anonymous_returns_401()
    {
        ...
        var resp = await client.DeleteAsync(new Uri($"/api/admin/news/{System.Guid.NewGuid()}", UriKind.Relative));
    ...
    public async Task Publish_anonymous_returns_401()
    {
        ...
        var resp = await client.PostAsync(new Uri($"/api/admin/news/{System.Guid.NewGuid()}/publish", UriKind.Relative), body);
