    ...
    IClassFixture<AdminAuthFixture>
{
    ...
    public async Task List_anonymous_returns_401()
    {
        ...
        var resp = await client.GetAsync(new Uri("/api/admin/topics", UriKind.Relative));
    ...
    public async Task List_SuperAdmin_returns_200_with_paged_result_shape()
    {
        ...
        var resp = await client.GetAsync(new Uri("/api/admin/topics?page=1&pageSize=20", UriKind.Relative));
    ...
    public async Task GetById_anonymous_returns_401()
    {
        ...
        var resp = await client.GetAsync(new Uri($"/api/admin/topics/{System.Guid.NewGuid()}", UriKind.Relative));
    ...
    public async Task Post_anonymous_returns_401()
    {
        ...
        var resp = await client.PostAsync(new Uri("/api/admin/topics", UriKind.Relative), body);
    ...
    public async Task Put_anonymous_returns_401()
    {
        ...
        var resp = await client.PutAsync(new Uri($"/api/admin/topics/{System.Guid.NewGuid()}", UriKind.Relative), body);
    ...
    public async Task Delete_anonymous_returns_401()
    {
        ...
        var resp = await client.DeleteAsync(new Uri($"/api/admin/topics/{System.Guid.NewGuid()}", UriKind.Relative));
