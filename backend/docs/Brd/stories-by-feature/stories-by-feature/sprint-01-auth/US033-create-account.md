...
- `register.page.ts` rewritten with ReactiveFormsModule, 8 BRD fields, cross-field confirmPassword validator
- `POST /api/auth/register` endpoint wired; CON017 success state shown, ERR013/ERR019 error keys mapped
- Translation keys updated in `en.json` + `ar.json`
