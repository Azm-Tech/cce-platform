...
public sealed class UserSyncRepository : IUserSyncRepository
{
    private readonly CceDbContext _db;
    private readonly IConfiguration _configuration;
    private readonly ILogger<UserSyncRepository> _logger;

    public UserSyncRepository(CceDbContext db, IConfiguration configuration, ILogger<UserSyncRepository> logger)
    {
        _db = db;
