...
public sealed class UserRoleAssignmentRepository : IUserRoleAssignmentRepository
{
    ...
    private readonly ILogger<UserRoleAssignmentRepository> _logger;

    public UserRoleAssignmentRepository(CceDbContext db, ILogger<UserRoleAssignmentRepository> logger)
    {
        _db = db;
        _logger = logger;
    }
